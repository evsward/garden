...
<body>
	<div class="container-fluid">
		...
		<div class="row" style="margin-top: 40px;">
			...
			<div class="col-md-10">
				<div class="container-fluid">
					<form action="${ctx }/service/hotelOrder" method='post' class="form-horizontal">
						<div class="row">
							<div class="col-md-4">
					...
					<table class="table table-hover table-bordered">
						<thead>
							...
							<th class="text-nowrap">客房类型</th>
							<th class="text-nowrap">提交人</th>
							<th class="text-nowrap">手机号</th>
							<th class="text-nowrap">房间数</th>
							<th class="text-nowrap">vip卡号</th>
							<th class="text-nowrap">特别说明</th>
							<th class="text-nowrap">入住时间</th>
							<th class="text-nowrap">房晚</th>
						...
						<tbody>
							<c:forEach items="${allOrders}" var="order" varStatus="idx">
								<tr id="tr${order.reserveId }">
									...
									<td class="text-nowrap">${order.vipId }</td>
									<td class="text-nowrap">${order.specialNotes }</td>
									<td class="text-nowrap"><fmt:formatDate value="${order.checkinDate }" pattern="yyyy/MM/dd" /></td>
									<td class="text-nowrap">${order.nights }</td>
									<td class="text-nowrap"><c:choose>
											...
											<c:when test="${order.orderState == 15 }">已入住</c:when>
										</c:choose></td>
