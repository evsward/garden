...
<body>
	<div class="page">
		...
		<div id="slideBox" class="slideBox">
			<div class="bd">
				<ul>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img_chywqh_01_49.png" /></a></li>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img8.jpg" /></a></li>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img_chywqh_01_42.png" /></a></li>
				</ul>
			</div>
		...
		<div class="main">
			<div class="orderList">
				<div class="head">
					...
					<p>
						<a
							href="${ctx }/h5client/bookroom/timeChoose?return_url=/h5client/bookroom/gardenHotelReservation"
							class="btn">&nbsp;</a> <span class="s1"> 入住 <fmt:formatDate value="${checkinDate }" pattern="MM/dd" />
