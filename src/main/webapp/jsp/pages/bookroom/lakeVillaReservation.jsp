...
<body>
	<div class="page">
		<div class="header">
			...
			<div class="title">会所酒店预定</div>
		</div>
		<div id="slideBox" class="slideBox">
			<div class="bd">
				<ul>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img11.jpg" /></a></li>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img46.jpg" /></a></li>
					<li><a class="pic" href="#"><img src="${ctx }/static/images/img42.jpg" /></a></li>
				</ul>
			</div>
		...
		<div class="main">
			<div class="orderList">
				<div class="head">
					<h2>会所酒店</h2>
					<p>
						<a href="${ctx }/h5client/bookroom/timeChoose?return_url=/h5client/bookroom/lakeVillaReservation" class="btn">&nbsp;</a>
