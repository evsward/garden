...
import com.sunshine.gardens.message.resp.Article;
import com.sunshine.gardens.message.resp.Music;
...
import com.sunshine.gardens.model.pojo.TemplateData;
import com.sunshine.gardens.model.pojo.Token;
import com.sunshine.gardens.model.pojo.WSSmsMessage;
import com.sunshine.gardens.model.pojo.WeixinGroup;
import com.sunshine.gardens.model.pojo.WeixinMedia;
import com.sunshine.gardens.model.pojo.WeixinOauth2Token;
import com.sunshine.gardens.model.pojo.WeixinQRCode;
import com.sunshine.gardens.model.pojo.WeixinUserInfo;
import com.sunshine.gardens.model.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static WeixinOauth2Token getOauth2AccessToken(String appId, String appSecret, String code) {
		if (StringUtils.isEmpty(appId) || StringUtils.isEmpty(appSecret) || StringUtils.isEmpty(code)) {
			log.info("参数不正确: appid" + appId + " appsecret:" + appSecret + " code:" + code);
			return null;
		}
	...
	public static boolean updateGroup(String accessToken, int groupId, String groupName) {
		...
		JSONObject jsonObject = CommonUtil
				.httpsRequest(requestUrl, "POST", String.format(jsonData, groupId, groupName));
	...
	public static RespMsg sendTemplateMsg(String openid, String accessToken, WSSmsMessage wsMsg) {
		// 微信公众号后台“模板消息”配置
		String templateId = "G0rdvwsPFHgNm5gHRkrMhZf58Yrh5fjzCdug1_zUomo";
		String resURL = String.format("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s",
				accessToken);
		TemplateData templateData = new TemplateData();
		String color = "#173177";
		Map<String, String> productType = new HashMap<String, String>();
		Map<String, String> name = new HashMap<String, String>();
		Map<String, String> accountType = new HashMap<String, String>();
		Map<String, String> account = new HashMap<String, String>();
		Map<String, String> time = new HashMap<String, String>();
		Map<String, String> remark = new HashMap<String, String>();
		productType.put("value", "客房预订");
		productType.put("color", color);
		name.put("value", "春晖园大床房");
		name.put("color", color);
		accountType.put("value", "会员卡");
		accountType.put("color", color);
		account.put("value", "A003881");
		account.put("color", color);
		time.put("value", "2016年1月25日");
		time.put("color", color);
		remark.put("value", "感谢您的使用！");
		templateData.setAccount(account);
		templateData.setAccountType(accountType);
		templateData.setName(name);
		templateData.setProductType(productType);
		templateData.setTime(time);
		templateData.setRemark(remark);

		Map<String, Object> mainObj = new HashMap<String, Object>();
		mainObj.put("touser", openid);
		mainObj.put("template_id", templateId);
		mainObj.put("url", "http://weixin.qq.com/download");// 点击“详情”跳转的位置。
		mainObj.put("topcolor", "#FF0000");
		mainObj.put("data", templateData);
		JSONObject jsonObj = JSONObject.fromObject(mainObj);
		String resultStr = HttpAPIClient.post(jsonObj.toString(), resURL);
		RespMsg resp = (RespMsg) JSONObject.toBean(JSONObject.fromObject(resultStr), RespMsg.class);
		return resp;
	}
	...
	public static void main(String args[]) {
		Token token = CommonUtil.getToken("wx707db3d7d53855a1", "849e5fc1c07055d227fc9dc58e659949");
		String openid = "oZU-Rs1c1AuixNLwI1c6aqWT_Tx8";
		RespMsg resp = sendTemplateMsg(openid, token.getAccessToken(), null);
